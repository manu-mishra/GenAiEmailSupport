...
# Deploy Stacks
kendra_stack = KendraStack(app,"KendraStack")
...
EmailAutomationWorkflowStack(app, "EmailAutomationWorkflowStack", support_email=workmail_stack.support_email_id, human_workflow_email=human_workflow_email, kendra_index = kendra_stack.kendra_index_id)
app.synth()
