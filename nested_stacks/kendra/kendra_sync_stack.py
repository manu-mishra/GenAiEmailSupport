...
class KendraDataSyncStack(cdk.NestedStack):
    ...
    def __init__(self, scope: cdk.App, construct_id: str,kendra_index_id: str, **kwargs) -> None:
        ...
        start_sync_lambda.add_to_role_policy(iam.PolicyStatement(
        ...
        data_source_created_rule.add_target(events_targets.LambdaFunction(self.start_sync_lambda))
